...
@onready var add_card_set_resource: Resource = preload("res://Data/Float Panel Data/add_card_set.tres")
@onready var folder_edit_resource: Resource = preload("res://Data/Float Panel Data/folder_edit.tres")
